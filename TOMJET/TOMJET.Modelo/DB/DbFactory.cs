...
using TOMJET.Modelo.DB.Repository;

namespace TOMJET.Modelo.DB
{
    public class DbFactory
    {
        ...
        private DbFactory()
        {
            ...
            VooRepository = new VooRepository(_sessionFactory);
            PassagemRepository = new PassagemRepository(_sessionFactory);
        }
        ...
        public static object Instace { get; set; }
